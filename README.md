...
The moralis integration has been removed. Please use the [the graph](https://github.com/Deekhay/nextjs-nft-marketplace-thegraph-c) integration instead.
...
```
git clone https://github.com/Deekhay/nextjs-smartcontract-lottery-c
cd nextjs-smartcontract-lottery-c
yarn
yarn dev
```
